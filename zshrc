...
export ZSH=/home/yigit/.oh-my-zsh
...
alias conkyrc='nvim ~/.config/conky/conky.conf'
alias rm='rm -i'
alias cp='cp -i'
...
PERL_LOCAL_LIB_ROOT="/home/yigit/perl5${PERL_LOCAL_LIB_ROOT+:}${PERL_LOCAL_LIB_ROOT}"; export PERL_LOCAL_LIB_ROOT;
PERL_MB_OPT="--install_base \"/home/yigit/perl5\""; export PERL_M_OPT;
